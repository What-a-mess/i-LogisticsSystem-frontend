...
const routes = [
    ...
    { path: '/', components: { default: login } },
    {
        ...
        children: [
            ...
            { path: 'mainsites/MAIN-001/inventory/sitein', component: MainSiteInInfo },
            { path: 'mainsites/MAIN-001/inventory/siteout', component: MainSiteOutInfo },
            { path: 'mainsites/MAIN-001/inventory/sitein/:recordId', component: MainSiteInDetail },
            { path: 'mainsites/MAIN-001/inventory/siteout/:recordId', component: MainSiteOutDetail },
            { path: 'mainsites/MAIN-001/inventory/warehouses', component: WarehouseMgmt },
