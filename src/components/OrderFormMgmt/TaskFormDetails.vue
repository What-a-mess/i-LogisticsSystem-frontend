            ...
            <BasicCard header="任务单详情" >
                <el-col :span="11" :offset="1">
                    <el-row>
                        <el-col>
                            <b>任务单编号：</b>
                            {{taskFromData[0].taskId}}
                        </el-col>
                    </el-row><br />
                    <el-row>
                        <el-col>
                            <b>主站ID：</b>
                            {{taskFromData[0].subSiteId}}
                        </el-col>
                    </el-row><br />
                    <el-row>
                        <el-col>
                            <b>配送时间：</b>
                            {{taskFromData[0].deliveryDateTime}}
                        </el-col>
                    </el-row><br />
                    <el-row>
                        <el-col>
                            <b>收件人：</b>
                            {{taskFromData[0].shipName}}
                        </el-col>
                    </el-row><br />
                    <el-row>
                        <el-col>
                            <b>收件地址：</b>
                            {{taskFromData[0].shipPro}}-{{taskFromData[0].shipCity}}-{{taskFromData[0].shipDis}}
                        </el-col>
                    </el-row><br />
                    <el-row>
                        <el-col>
                            <b>寄件人：</b>
                            {{taskFromData[0].billName}}
                        </el-col>
                    </el-row><br />
                    <el-row>
                        <el-col>
                            <b>寄件地址：</b>
                            {{taskFromData[0].billPro}}-{{taskFromData[0].billCity}}-{{taskFromData[0].billDis}}
                        </el-col>
                    </el-row><br />
                    <el-row>
                        <el-col>
                            <b>任务单总价：</b>
                            {{taskFromData[0].totalPrice}}
                        </el-col>
                    </el-row><br />
                    <el-row>
                        <el-col>
                ...
                <el-col :span="11" :offset="1">
                    <el-row>
                        <el-col>
                            <b>订单编号：</b>
                            {{taskFromData[0].orderId}}
                        </el-col>
                    </el-row><br />
                    <el-row>
                        <el-col>
                            <b>配送员：</b>
                            {{taskFromData[0].courier}}
                        </el-col>
                    </el-row><br />
                    <el-row>
                        <el-col>
                            <b>任务单状态：</b>
                            {{taskFromData[0].status}}
                        </el-col>
                    </el-row><br />
                    <el-row>
                        <el-col>
                            <b>收件人电话：</b>
                            {{taskFromData[0].shipTel}}
                        </el-col>
                    </el-row><br />
                    <el-row>
                        <el-col>
                            <b>收件人详细地址：</b>
                            {{taskFromData[0].shipAddr}}
                        </el-col>
                    </el-row><br />
                    <el-row>
                        <el-col>
                            <b>寄件人电话：</b>
                            {{taskFromData[0].billTel}}
                        </el-col>
                    </el-row><br />
                    <el-row>
                        <el-col>
                            <b>寄件人详细地址：</b>
                            {{taskFromData[0].billAddr}}
                        </el-col>
                    </el-row><br />
                    <el-row>
                        <el-col>
                ...
                <el-col :span="17" :offset="1">
                    <el-collapse
                            ...
                            v-for="orderItem in taskFromData[0].orderItems"
...
<script>
    ...
    export default {
        ...
        mounted() {
            this.taskFromData[0].orderId = this.$route.params.orderId;
            this.taskFromData[0].taskId = this.$route.params.taskId;
            this.fecthData();
        }
    }
</script>
