    ...
    <el-col :span="12">
        <BasicCard header="订单详情">
            <el-col style="text-align: left;">
                <el-row>
                    <el-col>
                <b>订单编号：</b>{{order.orderId}}
                    </el-col>
                </el-row>
                <el-row>
                   <el-col :span="12"><b>客户编号：</b>{{order.customerId}}</el-col>
                    <el-col :span="12"><b>客户姓名：</b>{{order.billName}}</el-col>
                </el-row>
                <el-row>
                    <el-col :span="12"><b>付款状态：</b>{{order.payStatus}}</el-col>
                    <el-col :span="12"><b>订单状态：</b>{{order.processStatus}}</el-col>
                </el-row>
                <el-row>
                    <el-col :span="12"><b>客户地区：</b>{{order.billPro}}-{{order.billCity}}-{{order.billDistrict}}</el-col>
                    <el-col :span="12">
                        <b>客户详细地址：</b>{{order.billAddr}}
                    </el-col >
                </el-row>
                <el-row>
                    <el-col :span="12"><b>订单总价：</b>{{order.totalPrice}}</el-col>
                    <el-col :span="12"><b>运费：</b>{{order.shippingCost}}</el-col>
                </el-row>
                <el-row>
                    <el-col><b>订单创建时间：</b>{{order.createDateTime}}</el-col>
                </el-row>
                <el-row>
                    <el-col><b>订单付款时间：</b>{{order.payDateTime}}</el-col>
                </el-row>
                <el-row>
                    <el-col><b>支付方式：</b>{{order.payMethod}}</el-col>
                </el-row>
                <el-row>
                    <el-col><b>订单备注：</b>{{order.note}}</el-col>
                </el-row>
                ...
                <el-row>
                    ...
                    <el-collapse style="width: 98%;padding-left: 3%" v-for="orderItem in orderItemList" v-bind:key="orderItem.orderId">
                        <el-collapse-item :title="orderItem.item.name">
                            <el-row>
                                <el-col :span="12">
                                    <b>商品大类ID：</b>{{orderItem.item.categoryId}}
                                </el-col>
                                <el-col :span="12">
                                    <b>商品大类ID：</b>{{orderItem.item.categoryId}}
                                </el-col>
                                <el-col :span="12">
                                    <b>任务单ID：</b>{{orderItem.taskId}}
                                </el-col>
                                <el-col :span="12">
                                    <b>任务单状态：</b>{{orderItem.status}}
                                </el-col>
                                <el-col :span="12">
                                    <b>商品下单数量：</b>{{orderItem.itemNum}}
                                </el-col>
                                <el-col :span="12">
                                    <b>商品状态：</b>{{orderItem.item.status}}
                                </el-col>
                                <el-col :span="12">
                                    <b>商品成本：</b>{{orderItem.item.unitCost}}
                                </el-col>
                                <el-col :span="12">
                                    <b>商品售价：</b>{{orderItem.item.listPrice}}
                                </el-col>
                                <el-col>
                                    <b>商品描述：</b>{{orderItem.item.descn}}
                                </el-col>
                                <el-col>
                                    <b>商品图片：</b>{{orderItem.item.imgUrl}}
                                </el-col>
                            </el-row>
                        </el-collapse-item>
                    </el-collapse>
